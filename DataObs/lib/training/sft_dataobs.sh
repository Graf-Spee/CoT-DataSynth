...
if [ "$nproc_per_node" -lt "$ulysses_sequence_parallel_size" ] || [ $((nproc_per_node % ulysses_sequence_parallel_size)) -ne 0 ]; then
...
echo "Using ulysses_sequence_parallel_size: $ulysses_sequence_parallel_size"
echo "=========================================="
