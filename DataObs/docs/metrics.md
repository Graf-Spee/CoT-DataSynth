...
本文档基于 `DataObs/scripts/data_obs_pipeline.py` 与 `DataObs/lib/*.py` 的当前实现整理，描述每个指标的真实含义与产出位置。
...
来源：`lib/metrics/data_metrics.py::compute_data_statistics`
...
来源：`lib/metrics/data_metrics.py::compute_data_quality_metrics`
...
来源：`lib/metrics/advanced_metrics.py::compute_dataset_diversity`
...
来源：`lib/metrics/advanced_metrics.py::compute_dataset_entropy`
...
来源：`lib/metrics/advanced_metrics.py::compute_ppl_metrics`
...
来源：`lib/metrics/advanced_metrics.py::compute_ifd_metrics`
...
来源：`lib/analysis/analysis_pipeline.py::CorrelationAnalyzer.compute_correlations`
...
来源：`lib/analysis/analysis_pipeline.py::AnalysisVisualizer.plot_correlation_heatmap`
...
脚本：`DataObs/tools/analyze_observation_deepseek.py`
...
python /home/hrh/CoT-DataSynth/DataObs/tools/analyze_observation_deepseek.py \
