"""
DataEvo metrics/split pipeline.
...
def main():
    parser = argparse.ArgumentParser(
        description='DataEvo Pipeline: Data analysis and training workflow'
    )
    ...
    parser.add_argument('--train_script', default='DataEvo/lib/training/sft_dataobs.sh', help='Training script path')
    parser.add_argument('--val_data_path', default='/data/open_datasets/GSM8K/main/test-00000-of-00001.parquet', help='Path to val dataset (parquet)')
